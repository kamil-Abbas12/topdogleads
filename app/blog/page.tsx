...
function Sidebar() {
  // With your current data, we can only safely show "Recent Post" from existing blogs.
  const recent = blogs.slice(0, 3);

  // Optional: tags/categories widgets need fields you don't have yet, so we render them in UI-only mode.
  const categories = [
