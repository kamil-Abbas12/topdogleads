...
const products = [
  {
    ...
    leads: "25 Leads",
    desc:
      "Bundle of 25 high-quality Final Expense leads curated to help you grow your business. Verified and tailored to connect with individuals actively seeking final expense coverage.",
    bullets: [
      "Verified prospects actively seeking coverage",
