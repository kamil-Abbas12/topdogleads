  ...
  return (
    ...
    >
      <div className="mx-auto max-w-7xl px-6 py-16 lg:py-20">
            ...
            <div ref={dropdownRef} className="relative w-64">
              ...
              {open && (
                <ul
                  ...
                  className="absolute left-0 top-full mt-2 w-full rounded-lg bg-white shadow-2xl z-50 overflow-hidden"
                >
                  {SERVICES.map((s) => (
        ...
        {/* GRID */}
        <ul
          className="mt-14 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 lg:gap-8"
          ...
          {SERVICES.map((s) => {
            ...
            return (
              <li key={s.id}>
                ...
                >
                  <div className="flex justify-center mb-6" aria-hidden="true">{s.icon}</div>
