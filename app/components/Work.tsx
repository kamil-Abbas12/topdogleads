...
const Work = () => {
  return (
    <section
      aria-label="How Top Dog Leads works — pay-per-call explained"
    ...
    >
      ...
      lg:pb-0 justify-center items-center text-center space-y-4">
        ...
        {/* Keyword-rich label — good for featured snippets */}
        <p className="text-sm sm:text-base md:text-lg text-gray-900 font-bold uppercase tracking-wider">
          How It Works
        </p>
