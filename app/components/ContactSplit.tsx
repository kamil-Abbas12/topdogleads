    ...
    <section className="min-h-screen bg-white text-black">
      <div className="mx-auto grid max-w-6xl grid-cols-1 gap-14 px-6 py-16 lg:grid-cols-2 lg:gap-20 lg:py-20">
        ...
        <div>
          ...
          <h1 className="mt-6 max-w-[12ch] text-5xl font-semibold leading-[1.02] tracking-tight sm:text-6xl lg:text-7xl">
            Let’s make <br />
            great things <br />
            happen.
          </h1>
        ...
        <div className="lg:pt-2">
          ...
          <form onSubmit={onSubmit} className="mt-10 space-y-8">
            ...
            <div className="pt-2">
              <button
                type="submit"
                className="inline-flex h-11 w-28 items-center justify-center bg-[#E11D2E] text-xs font-semibold tracking-[0.22em] text-white hover:bg-[#cf1828] focus:outline-none focus:ring-2 focus:ring-black/20"
              >
                SEND
              </button>
            </div>
