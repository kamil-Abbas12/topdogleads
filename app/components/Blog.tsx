  ...
  return (
    ...
    >
      <div className="text-center mb-12 flex flex-col items-center">
        ...
        <p
          className={`${manrope.className} text-gray-500 max-w-3xl text-center text-sm sm:text-base md:text-lg leading-relaxed mt-4`}
        >
          ...
          >
            ...
            <div className="p-6 flex flex-col flex-1">
              <div
                ...
                aria-label={`Written by ${blog.author} on ${blog.date}`}
              >
