      ...
      <div className="flex flex-col xl:flex-row justify-between items-center gap-10 w-full px-4 sm:px-6 md:px-10 xl:px-40 py-10 sm:py-16 xl:py-20">
        ...
        <div className="flex flex-col space-y-5 w-full xl:w-1/2">
          <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-800 leading-snug">
            Boost Your Business
 <br />
            with more qualified customers
          </h1>
          <h2 className="text-sm sm:text-md md:text-md text-gray-700 leading-relaxed">
Sign up now for our performance-based lead service and expand your reach. Launch multiple online campaigns while optimizing your business profile with relevant keywords, service details, coverage areas, images, and more.          </h2>
...
Increase your visibility across key marketing channels
              </h3>
            </div>
            ...
            <div className="flex gap-2 items-start sm:items-center">
              ...
              <h3 className="text-gray-700 text-sm sm:text-base">
Appear higher in local search results and Google Maps
              </h3>
            </div>
            ...
            <div className="flex gap-2 items-start sm:items-center">
              ...
              <h3 className="text-gray-700 text-sm sm:text-base">
Track every lead with our live, easy-to-use dashboard
              </h3>
            </div>
          </div>
