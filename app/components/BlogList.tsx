...
function Pagination({ page, totalPages }: { page: number; totalPages: number }) {
  // path-based instead of query-string, so each page can be statically
  // generated and gets its own correct canonical URL
...
export function BlogListContent({ page }: { page: number }) {
