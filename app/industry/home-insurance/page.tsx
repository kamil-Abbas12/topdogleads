        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-start">
          ...
          <div className="w-full">
            ...
            <p className="text-gray-600 mb-8 sm:mb-10 max-w-md">
              Join 3,000+ agents using Top Dog leads to get high-intent home
              insurance leads delivered straight to your phone
            </p>
                  ...
                  <div className="mt-auto pt-6">
                    <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4">
                      <button
                        type="button"
                        onClick={handleCtaClick}
                        className="w-full sm:w-1/2 cursor-pointer bg-[#1c2d56] hover:bg-[#1c2d56]/90 text-white font-semibold py-3
                         rounded-md transition"
                      >
                        Next
                      </button>
