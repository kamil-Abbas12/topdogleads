...
export default function MedicareInsurancePage() {
  ...
  try {
    const res = await fetch("/api/leads", {
      ...
      body: JSON.stringify({
        industry: "medicare-insurance-sales",
        company,
        email,
        buyerName,
        leadType,
    ...
    if (data.success) {
      router.push("/medicare-insurance-sales");
    } else {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-start">
          ...
          <div className="w-full">
            ...
            <p className="text-gray-600 mb-8 sm:mb-10 max-w-md">
              Join 3,000+ agents using Top Dog leads to get high-intent Medicare Insurance leads delivered straight to your phone
            </p>
            ...
            <div className="max-w-md w-full">
              ...
              {!formOpen && (
                <div className="space-y-5 sm:space-y-6">
                  <select
                    defaultValue="medicare-insurance"
                    disabled
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 pt-2 sm:pt-4">
                    <button
                      ...
                      className="w-full sm:w-50 cursor-pointer bg-[#1c2d56]
                       hover:bg-[#1c2d56]/90 text-white font-semibold py-3 rounded-md transition"
                    >
                      Get Calls
                    </button>
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4">
                      <button
                        ...
                        className="w-full sm:w-1/2 cursor-pointer
                         bg-[#1c2d56] hover:bg-[#1c2d56]/90 text-white font-semibold py-3 rounded-full transition"
                      >
                        Next
                      </button>
