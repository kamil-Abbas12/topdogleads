...
export default function MotorVehicleAccidentPage() {
  ...
  try {
    const res = await fetch("/api/leads", {
      ...
      body: JSON.stringify({
        industry: "motor-vehicle-accident",
        company,
        email,
        buyerName,
        leadType,
    ...
    if (data.success) {
      router.push("/motor-vehicle-accident-sales");
    } else {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-start">
          ...
          <div className="space-y-6 lg:space-y-8">
            ...
            <div className="relative w-full max-w-xl">
              <div className="relative w-full overflow-hidden rounded-md aspect-[3/2] sm:aspect-[16/10]">
                <Image
                  src="/lead.jpg"
                  alt="MotorVehicleAccident Leads"
                  fill
          ...
          <div className="w-full">
            ...
            <p className="text-gray-600 mb-8 sm:mb-10 max-w-md">
              Join 3,000+ agents using Top Dog leads to get high-intent Motor Vehicle Accident leads delivered straight to your phone
            </p>
            ...
            <div className="max-w-md w-full">
              ...
              {!formOpen && (
                <div className="space-y-5 sm:space-y-6">
                  <select
                    defaultValue="MotorVehicleAccident"
                    disabled
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 pt-2 sm:pt-4">
                    <button
                      ...
                      className="w-full sm:w-50 cursor-pointer bg-[#1c2d56] hover:bg-[#1c2d56]/90 text-white font-semibold py-3 rounded-md transition"
                    >
                      Get Calls
                    </button>
                  ...
                  <div className="mt-auto pt-6">
                    <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4">
                      <button
                        type="button"
                        onClick={handleCtaClick}
                        className="w-full sm:w-1/2 cursor-pointer bg-[#1c2d56] hover:bg-[#1c2d56]/90
