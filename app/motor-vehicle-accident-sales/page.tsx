...
const Solars = [
  {
    ...
    price: "$624",
    period: "/bundle",
    cta: "Buy Motor Vehicle Accident Leads Bundle",
    leads: "25 Leads",
    desc:
      "Bundle of 25 high-quality Motor Vehicle Accident leads curated to help you grow your business. Verified and tailored to connect with individuals actively seeking Motor Vehicle Accident solutions.",
    bullets: [
      "Verified prospects actively seeking Motor",
  ...
  },
  {
    ...
    leads: "50 Leads",
    desc:
      "Bundle of 50 premium Motor Vehicle Accident leads designed to accelerate your sales pipeline. Each lead is verified and ready to connect you with interested clients.",
    bullets: [
  ...
  },
  {
    ...
    leads: "100 Leads",
    desc:
      "Bundle of 100 top-quality Motor Vehicle Accident leads, optimized to maximize your outreach and conversions. Perfect for agencies looking for large-scale lead acquisition.",
    bullets: [
    ...
    <div className="rounded-2xl border border-gray-200 bg-white p-6 sm:p-7 shadow-sm hover:shadow-md transition flex flex-col">
      ...
      <div className="mt-5">
        ...
        <div className="mt-2 text-sm text-gray-500">
          Choose your volume and delivery preferences for Motor Vehicle Accident leads.
        </div>
      </div>
      ...
      <ul className="mt-4 space-y-3">
        ...
        <li className="flex items-start gap-3 text-sm leading-relaxed text-gray-700">
          <span className="mt-1.5 h-2.5 w-2.5 rounded-full bg-orange-500/80" />
          <span>Targeted Motor Vehicle Accident leads</span>
        </li>
        <li className="flex items-start gap-3 text-sm leading-relaxed text-gray-700">
          <span className="mt-1.5 h-2.5 w-2.5 rounded-full bg-orange-500/80" />
...
export default function PestControlSalesPage() {
  return (
      ...
      <section className="relative w-full">
        <div className="relative w-full h-[180px] sm:h-[220px] lg:h-[260px] overflow-hidden">
          <Image
            ...
            alt="Our Motor Vehicle Accident Sales header"
            fill
