...
const Solars = [
  {
    ...
    price: "$624",
    period: "/bundle",
    cta: "Buy medicare Insurance Leads Bundle",
    leads: "25 Leads",
    desc:
      "Bundle of 25 high-quality medicare Insurance leads curated to help you grow your business. Verified and tailored to connect with individuals actively seeking medicare Insurance solutions.",
    bullets: [
  ...
  },
  {
    ...
    leads: "50 Leads",
    desc:
      "Bundle of 50 premium medicare Insurance leads designed to accelerate your sales pipeline. Each lead is verified and ready to connect you with interested clients.",
    bullets: [
  ...
  },
  {
    ...
    leads: "100 Leads",
    desc:
      "Bundle of 100 top-quality Medicare Insurance leads, optimized to maximize your outreach and conversions. Perfect for agencies looking for large-scale lead acquisition.",
    bullets: [
    ...
    <div className="rounded-2xl border border-gray-200 bg-white p-6 sm:p-7 shadow-sm hover:shadow-md transition flex flex-col">
      ...
      <div className="mt-5">
        ...
        <div className="mt-2 text-sm text-gray-500">
          Choose your volume and delivery preferences for Medicare Insurance leads.
        </div>
      </div>
      ...
      <ul className="mt-4 space-y-3">
        ...
        <li className="flex items-start gap-3 text-sm leading-relaxed text-gray-700">
          <span className="mt-1.5 h-2.5 w-2.5 rounded-full bg-orange-500/80" />
          <span>Targeted Medicare Insurance leads</span>
        </li>
        <li className="flex items-start gap-3 text-sm leading-relaxed text-gray-700">
          <span className="mt-1.5 h-2.5 w-2.5 rounded-full bg-orange-500/80" />
...
export default function MedicareInsuranceSalesPage() {
  return (
      ...
      <section className="relative w-full">
        <div className="relative w-full h-[180px] sm:h-[220px] lg:h-[260px] overflow-hidden">
          <Image
            ...
            alt="Our Medicare Insurance Sales header"
            fill
